...
<body>
<h1><marquee behavior="alternate">Update SubCategory</marquee></h1>
...
<tr>
	...
	<th> Update </th>
		...
		<c:forEach items="${subcatList}" var="subcategory">
			    ...
			    <td><a href="./updateDetails1?subcid=${subcategory.getsubcategoryId()}&cid=${subcategory.getcategoryId()}"> Update </a></td>
			    	 </tr>
		</c:forEach>	
		</tbody>	
		</table>
