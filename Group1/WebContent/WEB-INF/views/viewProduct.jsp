...
<body>
<h1><marquee behavior="alternate">View Product</marquee></h1>
	...
	<tbody>	
		<c:forEach items="${prodList}" var="product">
				<tr>
			    	 ...
			    	 <td><image  height="100px" width="200px" src="${product.getProductImageURI()}"/></td>
			    	 <td><c:out value="${product.getSubCategoryId()}" /></td>	
			    	  <td><a href="./viewProductById?productId=${product.getProductId()}">view </a></td>
				</tr>
		</c:forEach>		
		</table>
			</tbody>   
