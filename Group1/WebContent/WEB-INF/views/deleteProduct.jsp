...
<body>
<h1><marquee behavior="alternate"> Delete Product</marquee></h1>
...
<th>Product ID </th>
	...
	<th>Sub Category Id</th>
		...
		<c:forEach items="${prodList}" var="product">
			    ...
			    <td><a href="./deleteProduct1?productId=${product.getProductId()}&subid=${product.getSubCategoryId()}"> Delete </a></td>
